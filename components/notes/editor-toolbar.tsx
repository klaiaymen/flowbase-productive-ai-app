...
export function EditorToolbar({ editor, voiceControl }: EditorToolbarProps) {
  const handleLink = () => {
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-100/80 bg-white/80 px-6 py-2 backdrop-blur-sm">
      ...
      {voiceControl && <div className="flex items-center">{voiceControl}</div>}
    </div>
  );
}
